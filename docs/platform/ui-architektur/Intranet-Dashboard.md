...
- **Drafts-Tab** auf den Scope-Seiten (Personal, Company, Department, Team, ggf. Shared): Ein Tab „Drafts“ mit (1) noch nicht veröffentlichten Dokumenten und (2) Einträgen, die auf Prüfung oder Freigabe warten. Details in [Umsetzungs-Todo §15](../../plan/Umsetzungs-Todo.md#15-versionierung--ausblick). Datenmodell und Zielbild siehe [Prisma-Schema-Entwurf](../../plan/Prisma-Schema-Entwurf.md) (§3, §8) sowie [Edit-System-Plan](../../plan/Edit-System-Blocks-Suggestions-Lead-Draft.md).
