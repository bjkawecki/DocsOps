...
- **Sprache:** Standardsprache für UI-Quelltexte, Routen und API-Pfade ist **Englisch**; App-UI zusätzlich **DE** über i18n (Keys/Fallback EN). Vorgaben: [Plan-App-i18n](Plan-App-i18n.md).
