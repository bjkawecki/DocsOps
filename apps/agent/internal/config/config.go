...
func LoadFromEnv() (Config, error) {
	...
	cfg := Config{
		...
		DemoHookEnabled: envTruthy("DOCSOPS_DEMO_HOOK_ENABLED"),
		DemoHookToken:   strings.TrimSpace(os.Getenv("DOCSOPS_DEMO_HOOK_TOKEN")),
	...
	if cfg.DemoHookEnabled && cfg.DemoHookToken == "" {
		return Config{}, fmt.Errorf("DOCSOPS_DEMO_HOOK_TOKEN is required when DOCSOPS_DEMO_HOOK_ENABLED is set")
	}
