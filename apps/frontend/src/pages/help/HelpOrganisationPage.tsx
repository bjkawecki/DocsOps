    ...
    <Stack gap="sm" align="stretch" style={{ textAlign: 'left' }}>
      <Stack gap={6}>
        ...
        <Text size="md">
          ...
          team. You may also have a <strong>personal</strong> area for your own drafts and projects.
          The catalog and navigation reflect where you have access.
        </Text>
      </Stack>
      <Stack gap={6}>
      ...
      <Stack gap={6}>
        ...
        <Text size="md">
          ...
          playbooks, or line-of-business documentation that is often tied to how work runs rather
          than to a single initiative. Naming is a guide, not a rule–pick the shape your team will
          recognise.
        </Text>
      </Stack>
      <Stack gap={6}>
        ...
        <List size="md" spacing="xs">
          ...
          <List.Item>
            <strong>Process</strong> when documentation is naturally described as a flow, standard,
            or recurring operational context.
          </List.Item>
        </List>
      </Stack>
    </Stack>
