...
export function HelpOutOfScopePage() {
  return (
    <Stack gap={0} align="stretch" style={{ textAlign: 'left' }}>
      ...
      <Text component="p">
        DocsOps holds <strong>durable internal knowledge</strong> with an official published stand:
        how the organisation works (processes) and what it is building or running (projects). It is
        not a replacement for every tool that stores text or tracks work.
      </Text>
      <Text component="p">
      ...
      <List spacing="sm">
        ...
        <List.Item>
          <strong>Public product or API docs / developer portals</strong> – external audiences, SEO,
          public branding. Use dedicated doc sites; DocsOps stays intranet and org-native.
        </List.Item>
        <List.Item>
        ...
        <List.Item>
          <strong>Line-of-business systems</strong> – CRM, HR, ERP master data. Those systems remain
          authoritative; DocsOps may only link to them.
        </List.Item>
        <List.Item>
          <strong>Live ops signals</strong> – monitoring, alerts, dashboards. Put <em>runbooks</em>{' '}
          for those signals in DocsOps; keep the signal itself in the observability stack.
        </List.Item>
        <List.Item>
      ...
      <List spacing="xs">
        ...
        <List.Item>
          <strong>Runbook for alert X</strong> → DocsOps; <strong>the alert UI</strong> → ops tools.
        </List.Item>
        <List.Item>
          <strong>Meeting decision</strong> → DocsOps (notes or ADR); <strong>meeting chat</strong>{' '}
          → not.
        </List.Item>
      </List>
    </Stack>
