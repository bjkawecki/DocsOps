  ...
  return (
    <Stack gap="md" align="stretch" style={{ textAlign: 'left' }}>
      ...
      <Stack gap={6}>
        ...
        <List spacing="sm">
          <List.Item>
            ...
            protected”). Standard makes it measurable (“passwords ≥ 12 characters”).
          </List.Item>
          <List.Item>
            <strong>Standard vs Baseline:</strong> Standard is an abstract rule you can audit.
            Baseline is a concrete minimum config (e.g. hardened VM image).
          </List.Item>
          <List.Item>
          ...
          <List.Item>
            <strong>Procedure vs Runbook vs Playbook:</strong> Procedure = calm, recurring SOP.
            Runbook = time-critical incident response. Playbook = multi-role workflow with phases
            (often proactive, not only incidents).
          </List.Item>
          <List.Item>
            <strong>Checklist vs Procedure:</strong> Checklist = tickable verification. Procedure =
            explained steps with ownership.
          </List.Item>
        </List>
      </Stack>
      ...
      <Stack gap={6}>
        ...
        <List spacing="sm">
          <List.Item>
            <strong>Repository documentation vs Architecture overview:</strong> Repo docs cover one
            codebase. Architecture overview maps the wider system.
          </List.Item>
          <List.Item>
            <strong>ADR vs Architecture overview:</strong> ADR records one decision and trade-offs.
            Architecture overview is the living map; update ADRs when decisions change.
          </List.Item>
          <List.Item>
            <strong>Meeting notes vs ADR:</strong> Meeting notes capture a discussion. Promote a
            lasting technical choice into an ADR.
          </List.Item>
          <List.Item>
          ...
          <List.Item>
            <strong>Known issue:</strong> Knowledge-base workaround and tracker link – not a
            substitute for the issue tracker’s status and assignment.
          </List.Item>
        </List>
      </Stack>
      ...
      <Stack gap={6}>
        ...
        <Text>
          ...
          template. Built-in types ship with the platform and cannot be deleted.
        </Text>
        <List spacing="xs">
